...
const Toastcore = ({ icon, iconColor, message }) => {
  ...
  return (
    <div
      id="toast"
      class="fixed bottom-10 z-50 -left-full transition-all duration-500 ease-in-out flex items-center w-full max-w-xs p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800"
      role="alert"
    >
